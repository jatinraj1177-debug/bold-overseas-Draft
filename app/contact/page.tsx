...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send the form data to the client's email via FormSubmit API
      await fetch("https://formsubmit.co/ajax/Sairamgade@boldoverseas.com", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          _subject: "New General Inquiry - Bold Overseas",
          Name: formData.name,
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-xl border border-gray-100 h-full relative overflow-hidden">
                <AnimatePresence mode="wait">
                  {!isSubmitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <select
                              id="destination" name="destination" value={formData.destination} onChange={handleChange}
                        ...
                        <motion.button
                          ...
                          className="w-full py-4 rounded-xl bg-gradient-to-r from-[#0B3B7A] to-[#1D4ED8] text-white font-semibold shadow-lg shadow-blue-500/25 hover:shadow-xl transition-shadow disabled:opacity-70"
                        >
                    ...
                    >
                      ...
                      <h3 className="text-2xl font-bold text-[#0B3B7A] mb-2">Message Sent!</h3>
                      <p className="text-gray-600 mb-6">Thank you for reaching out. One of our education experts will contact you shortly.</p>
                      <button 
                        onClick={() => { setFormData({ name: "", email: "", phone: "", destination: "", message: "" }); setIsSubmitted(false); }}
            ...
            >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919966704042" className="text-gray-600 hover:text-[#0B3B7A] transition-colors">
                        +91 99667 04042
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:Sairamgade@boldoverseas.com" className="text-gray-600 hover:text-[#0B3B7A] transition-colors">
                        Sairamgade@boldoverseas.com
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl p-2 shadow-xl border border-gray-100 overflow-hidden">
                <div className="rounded-2xl overflow-hidden">
                 <iframe
  src="https://maps.google.com/maps?q=Raaga+Residency,+Road+Number+44,+Ayyappa+Society,+Madhapur,+Hyderabad,+Telangana&t=&z=15&ie=UTF8&iwloc=&output=embed"
  width="100%"
  height="300"
  style={{ border: 0 }}
  allowFullScreen
...
/>
              ...
              <div className="bg-gradient-to-br from-[#0B3B7A] to-[#1D4ED8] rounded-3xl p-8 text-white">
                ...
                <p className="text-white/80 mb-6 text-sm leading-relaxed">
                  Get personalized guidance directly from our experts. Schedule a one-on-one consultation to discuss your study abroad goals.
                </p>
