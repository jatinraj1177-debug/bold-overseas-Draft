...
const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/share/199bVdKJNY/?mibextid=wwXIfr',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/boldoverseas?igsh=MWZ2OTh0ZWtjZnF3Mw==',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="mb-4">
              ...
              >
                ...
                <span className="text-sm">+91 99667 04042</span>
              </a>
            </div>
            ...
            <div>
              <a
                href="mailto:Sairamgade@boldoverseas.com"
                className="flex items-center gap-3 text-white/60 hover:text-white transition-colors"
              >
                <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center text-white">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-sm">Sairamgade@boldoverseas.com</span>
              </a>
            </div>
          </motion.div>
        </div>
